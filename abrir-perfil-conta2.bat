@echo off
REM Abre o Chrome no MESMO perfil que o Vperts Multi usa pra Conta 2.
REM Use isto pra instalar o Tampermonkey + o bridge nesse perfil (uma vez).
REM Depois feche este Chrome e reabra o app -> a Conta 2 tera o bridge.
setlocal
...
start "" "%CH%" --user-data-dir="%USERPROFILE%\.poke-multi-labs\perfis\conta-2"
