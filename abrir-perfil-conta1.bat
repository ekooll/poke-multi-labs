@echo off
REM Abre o Chrome no MESMO perfil que o Vperts Multi usa pra Conta 1.
REM Use isto pra instalar o Tampermonkey + o bridge nesse perfil (uma vez).
REM Depois feche este Chrome e reabra o app -> a Conta 1 ja tera o bridge.
setlocal
...
start "" "%CH%" --user-data-dir="%USERPROFILE%\.poke-multi-labs\perfis\conta-1"
